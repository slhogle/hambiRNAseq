...
untar(tarfile="data_raw/16S_amplicon/bbmap_rpkm.tar.gz", exdir="data_raw/16S_amplicon")

mapdir <- here::here("data_raw", "16S_amplicon", "bbmap_rpkm")
...
write_tsv(counts1, here::here("data", "16S_amplicon", "species_counts.tsv"))
write_tsv(counts1_wide, here::here("data", "16S_amplicon", "species_counts_wide.tsv"))

# Clean up ----------------------------------------------------------------

unlink("data_raw/16S_amplicon/bbmap_rpkm", recursive = T)
